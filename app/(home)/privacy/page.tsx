...
const privacyPage = () => {
  ...
  return (
    <div className="container mx-auto px-10 py-8 mt-2 bg-gradient-to-r from-slate-800 to-cyan-900  rounded-lg" >
      <h1 className="text-3xl font-bold mb-4"><p>Privacy Policy <Lock/></p></h1>
      <p className="mb-4">Last updated: May 01, 2024</p>
      <p className="mb-4">
      ...
      <ul className="mb-4">
        ...
        <li className="mb-2">
          ...
          this Agreement) refers to Motor Insurance Corp, IIIT Dharwad, KA
          580009.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Website</strong> refers to Motor Insurance Company, accessible
          from{" "}
          <a
            href="https://dbms-project-navy.vercel.app/"
            rel="external nofollow noopener"
            target="_blank"
            className="text-blue-500 hover:underline"
          >
            https://dbms-project-navy.vercel.app/
          </a>
        </li>
        <li>
      ...
      <p className="mb-4">
        Your information, including Personal Data, is processed at the Company&aposs
      ...
      <h2 className=" text-xl font-bold mt-4 mb-4">Children&aposs Privacy</h2>
      <p>
      ...
      <h2 className=" text-xl font-bold mt-4 mb-4">Links to Other Websites</h2>
      <p>
        Our Service may contain links to other websites that are not operated by
        Us. If You click on a third party link, You will be directed to that
        third party&aposs site. We strongly advise You to review the Privacy Policy
      ...
      <h1 className="text-3xl font-bold mb-4 mt-4">Contact us</h1>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://dbms-project-navy.vercel.app/support"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://dbms-project-navy.vercel.app/support
          </a>
        </li>
      </ul>
    </div>
