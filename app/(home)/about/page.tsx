...
const Supportpage = () => {
  return (
    <div className="grid justify-center align-middle 2xl:mt-40 grid-rows-2 h-full gap-32 bg-gradient-to-br from-blue-gray-800 via-blue-gray-900 to-black bg-opacity-70">
